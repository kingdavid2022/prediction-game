...
const Home = () => {
  ...
  const RenderTabs = () => {
    if (tab == "contest") {
      ...
      return (
        <div className=" w-[90%] sm:h-auto  flex flex-col items-center overflow-y-scroll h-auto  sm:grid  place-items-center sm:grid-cols-3  scrollbar-hide mt-[17vh] sm:mt-[10%]">
          {allTransactions &&
  ...
  return (
    <div className="w-screen h-auto min-h-screen bg-image bg-cover bg-no-repeat box-border flex flex-col items-center overflow-x-hidden scrollbar-hide scroll-pt-[10%]">
      <Head>
