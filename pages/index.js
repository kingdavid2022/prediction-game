  ...
  return (
    <div className="w-screen h-auto min-h-screen bg-black box-border flex flex-col items-center overflow-x-hidden scrollbar-hide scroll-pt-[10%]">
      ...
      {!walletConnected ? (
        ...
        <button onClick={mintToken} className={` fixed z-[10] bg-[#099E71] top-[50px] sm:top-[20px] min-h-[30px] min-w-[100px] sm:w-[7vw] sm:min-h-[35px] rounded-[10px] sm:max-h-[40px] right-[20px] sm:right-[40px]`}>
