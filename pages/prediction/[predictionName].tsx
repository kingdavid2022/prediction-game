...
const Prediction: NextPage = () => {
  ...
  return (
    <div className="w-screen h-screen flex flex-col items-center justify-center bg-black">
      ...
      <div className="w-[80%] h-[75%] flex flex-col items-center justify-start bg-gradient-to-r from-[#1D3736]  to-[#07580A] shadow-prediction rounded-[20px] box-border pt-2">
        ...
        <div className="w-[100%] h-[100%] flex items-center justify-evenly">
          <div className="w-[45%] h-[90%] flex flex-col items-start justify-between box-border pl-[5%]">
            <span className="text-white font-bold text-[2rem]">YOUR PREDICTION</span>
            ...
            <button className="self-end w-[30%] min-h-[35px] max-h-[40px] rounded-[10px] bg-[#099E71] m-9 text-white text-[1.3rem]">Predict</button>
          </div>
          <div className="w-[5px] bg-white h-[75%] rounded-[100%]"></div>
          <div className="w-[45%] h-[90%] flex flex-col items-center justify-between pb-[5%]">
          <span className="text-white font-bold text-[2rem]">YOUR PREDICTION</span>
              <div className="flex flex-col w-[100%] h-[80%] justify-start overflow-y-scroll items-start box-border pl-[25%] scrollbar-hide">
