...
const PredictedDetails = ({ Fee, date, logo, predictedValue, price, reward, token, frequency }:PredictionDetailsProps) => {
  return (
    <div className="w-[75%] h-[40%] min-h-[300px] min-w-[300px] mr-8 mt-8 bg-gradient-to-r from-[#1D3736]  to-[#07580A] rounded-[15px] flex flex-col items-center justify-start p-[4%]">
      <div className="w-[100%] h-[40%] flex items-center justify-between -mt-3">
        <div className="flex items-center justify-start w-[50%]">
          <img
            src={logo}
            alt=""
            className="w-[8vh] h-[8vh] rounded-[100%] min-w-[50px] min-h-[50px]"
          />
